...
public class BasePaxelItem extends DiggerItem implements VanillaToolActionItem {
    ...
    @Override
    public boolean port_lib$canPerformAction(ItemStack stack, ToolAction action) {
